...
############################# Start Here! ##############################
cupcake_shop_name = "Made with love"
...
def print_signatures():
    ...
    # your code goes here!    
    for order in signature_flavors:
        print ("- '%s'" % order)
    print()
...
def get_order():
    ...
    while order.lower() != "exit":
        if is_valid_order(order):
            ...
            print("Enter the exact spelling of the item you want.")
